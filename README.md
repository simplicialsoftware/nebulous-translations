...
- Remember you are on GitHub – translation files involve coding, so it's greatly recommended that you have comprehension over it to avoid issues with the linter. Always be careful while checking out to make sure your PR can be merged safely.
